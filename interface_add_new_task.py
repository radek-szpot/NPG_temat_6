...
def open_window_task(json_data):
    window_task_root = Tk()
    ...
    confirm_button = Button(window_task_root, text="confirm", command=lambda : add_new_task_interface(json_data,
                                                                                            name.get(),
                                                                                            description.get(),
                                                                                            importance.get()))
...
def add_new_task_interface(json_data, name, description, importance):
